...
/**
 * replace_value - This replaces the value at
 * a pre-existing key
 * @ht: the double pointer to the hash_node_t list
 * @key: the new key to add in the node
 * @value: the value to add in the node
 */
...
/**
 * check_key - This checks if a key exists
 * in a hash table
